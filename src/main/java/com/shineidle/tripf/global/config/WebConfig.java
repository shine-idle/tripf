...
import com.shineidle.tripf.global.security.filter.JwtAuthFilter;
import com.shineidle.tripf.global.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.shineidle.tripf.global.security.oauth2.handler.OAuth2AuthenticationFailureHandler;
import com.shineidle.tripf.global.security.oauth2.handler.OAuth2AuthenticationSuccessHandler;
import com.shineidle.tripf.global.security.oauth2.service.CustomOAuth2UserService;
...
public class WebConfig {
    ...
    private static final String[] WHITE_LIST = {
            "/", "/error", "/api/", "/signup", "/api/signup", "/api/login", "/login",
            "/api/products/**", "/products/**", "/chat/**", "/feeds/*", "/feeds/countries/**",
            "/payments/**", "/proxyTest/**",
